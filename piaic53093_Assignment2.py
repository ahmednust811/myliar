...
def function1():
    ...
    x= np.arange(1,13)# Write your code here 
    x = x.reshape(2,6)
...
def function2():
    ...
    x =  np.arange(10.0,37.0,dtype = float)
...
def function3():
    ...
    f_arr = arr%35 ==0
    x = arr[f_arr] #wrtie your code here
    return x
    """
    Expected Output:
...
def function4():
    ...
    return np.stack((arr[:,1],arr[:,0],arr[:,2]),axis =1)#wrtie your code here
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function7():
    ...
    return np.array(np.zeros(4),dtype=np.int64)#write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt =np.stack((arr[0,:]-brr[0],arr[1,:]-brr[1],arr[2,:]-brr[2])) # write your code here 
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack((np.full((1,3),arr[0])[0],np.full((1,3),arr[1])[0],np.full((1,3),arr[2])[0],arr,arr,arr))#write your code here 
...
def function14():
    ...
    ans = np.array_split(arr.reshape(8,3),4)#write your code here 
...
def function17():
    ...
    new_arr = np.full((10,10),'NO')
    lims= np.where((arr%3==0) & (arr%5==0))
    for i in range(len(lims)+1):
        new_arr[lims[0][i]][lims[1][i]]= 'YES'
    arr = new_arr
...
def fucntion20():
    ...
    def xyz(x):
        return x*2+3-2
    X=xyz(x)
    return X[X%2==1]#Write your Code here
